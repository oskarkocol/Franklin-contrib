...
export const MODEL_PRICING: Record<string, { input: number; output: number; perCall?: number }> = {
  ...
  'xai/grok-4.3': { input: 1.25, output: 2.5 },        // public flagship — refreshed 2026-07-06 via narev
  'xai/grok-build-0.1': { input: 1.0, output: 2.0 },  // agentic coding — refreshed 2026-07-06 via narev
