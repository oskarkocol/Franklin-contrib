...
export const MODEL_PRICING: Record<string, { input: number; output: number; perCall?: number }> = {
  ...
  'xai/grok-4.3': { input: 1.25, output: 2.5 },        // refreshed 2026-08-03 via narev public pricing
  'xai/grok-4.5': { input: 2.0, output: 6.0 },        // refreshed 2026-08-03 via narev public pricing
  'xai/grok-build-0.1': { input: 1.0, output: 2.0 },  // refreshed 2026-08-03 via narev public pricing
