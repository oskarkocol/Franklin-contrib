...
export const MODEL_PRICING: Record<string, { input: number; output: number; perCall?: number }> = {
  ...
  'deepseek/deepseek-chat': { input: 0.14, output: 0.28 }, // refreshed 2026-08-03 via narev (deepseek-v4-flash)
  'deepseek/deepseek-reasoner': { input: 0.14, output: 0.28 }, // refreshed 2026-08-03 via narev (deepseek-v4-flash)
