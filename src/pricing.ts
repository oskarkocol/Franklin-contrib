...
export const MODEL_PRICING: Record<string, { input: number; output: number; perCall?: number }> = {
  ...
  'xai/grok-4.3': { input: 2.5, output: 5.0 },        // refreshed 2026-07-13 via narev public pricing
  'xai/grok-build-0.1': { input: 1.0, output: 2.0 },  // refreshed 2026-07-13 via narev public pricing
